...
function Home() {
  ...
  return (
    <div className="App font-jetbrains bg-gradient-to-tr from-white via-purple-200 to-blue-300 flex w-screen h-screen justify-items-center items-center">
      <div className="grid grid-cols-2 gap-4 mx-auto max-w-7xl">
        <div
          id="header"
          className="col-span-2 bg-white shadow-sm rounded-3xl px-8 py-6 mt-auto flex justify-center border-4 border-pink-500"
        >
          <h1 className="text-6xl font-bold font-jetbrains">{title}</h1>
        </div>

        <div
          id="nameSection"
          className="bg-blue-200 border-4 border-pink-500 rounded-3xl p-4 flex flex-col justify-center items-center"
        >
          <h2 className="text-lg font-jetbrains font-bold">Enter Your Name</h2>
          <input
            type="text"
            className="col-span-2 border-2 border-black rounded-lg px-2 py-1 mr-2 mt-2 text-center"
        ...
        <div
          id="previewSection"
          className="row-span-2 col-span-1 bg-white border-4 border-pink-500 rounded-3xl h-full flex flex-col p-10 justify-items-center items-center"
        >
        ...
        <div
          ...
          className="bg-yellow-100 border-4 border-pink-500 rounded-3xl p-4"
        >
        ...
        <div
          ...
          className="col-span-2 flex flex-col w-full justify-items-center items-center bg-blue-400 border-4 border-pink-500 rounded-3xl px-64 py-4"
        >
